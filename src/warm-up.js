...
if ( stockCount >= 1) {
  console.log('Im going to eat some sweet potatos');
}
  else {
    console.log('We need to get some more sweet potatos');
  }
...
if(isFavorite === false){
  console.log('My favorite food is sweet potatos');
}

  else {
    console.log('I recently ate sweet potatos ');
  }
...
var vegetables = [
  'carrots','celery','eggplant','pumckin','artichoke'
];
...
var fruits = [
  'apples','peaches','pears','lemons','grapefruit','olives','dates'
]
